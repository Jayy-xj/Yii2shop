...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="">首页</a> > <a href="">电脑、办公</a> > <a href="">笔记本</a> > <?=$goods->name?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="/images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?='http://admin.yii2shop.com'.$goods->logo?>" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['goods/add'])?>" method="post" class="choose">
                    <ul>
                        <li>
                            <dl>
                                <dt>购买数量：</dt>
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <li><span>上架时间：</span>2013-09-18 17:58:122</li>
